...
dataPreprocessing <- function (genotypeFile, phenotypeFile, params) 
{
	...
	imputedFiles <-filteringImputationMAFCommonNames (4, phenotypeFile, genotypeFile, "ACGT", 1)
...
#-------------------------------------------------------------
#-------------------------------------------------------------
filteringImputationMAFCommonNames <- function(ploidy, pheno.file, geno.file, format, n.traits, delim = ",", MAFTHRESHOLD=0.001, IMPUTATION=T){
